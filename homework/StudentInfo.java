	...
	public static void main(String[] args) {
		...
		if (frist == 1) {
			...
			if (database.equals("school")) {
				...
				System.out.println("데이터베이스 선택이 완료되었습니다.");
				...
				if (collection.equals("student")) {
					...
					System.out.println("컬렉션 선택이 완료되었습니다.");
					...
					while (true) {
						...
						case 2:
							...
							Document mydoc = new Document("num", num).append("name", name)
									.append("field", new Document("college", college).append("department", department))
									.append("grade", grade).append("gender", gender).append("mail", mail)
						...
						case 3:
							...
							if (mycol.find(Filters.eq("num", num)) != null) {
								...
								System.out.println("해당학생의 정보가 삭제되었습니다.");
							} else {
						...
						case 4:
							...
							if (mycol.find(Filters.eq("num", num)) != null) {
								...
								System.out.println("업데이트가 정상적으로 이뤄졌습니다.");
							} else {
								System.out.println("해당 학생이 존재하지 않습니다.");
							}
						...
						case 6:
							...
							if (find == 1) {
								...
								department = sc.next();
								// Getting the iterable object
								FindIterable<Document> iterDoc1 = mycol
										.find(Filters.eq("field.department", department));
								// Getting the iterator
								Iterator it1 = iterDoc1.iterator(); // iterator 반환
								while (it1.hasNext()) {
									System.out.println(it1.next());
					...
					System.out.print("해당 컬렉션이 존재하지 않습니다.");
			} else
				System.out.print("해당 데이터베이스가 존재하지 않습니다.");
		} else
			System.out.print("1)번의 사용할 DB와 Collection를 선택 후 이용 가능 합니다. ");
